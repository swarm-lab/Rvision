...
#'  with Alpha channel), and "GRAY" (grayscale image). Converting from a Bayer mosaic to BGR is also possible with "BayerBG2BGR","BayerGB2BGR", "BayerRG2BGR", "BayerGR2BGR".
#'
