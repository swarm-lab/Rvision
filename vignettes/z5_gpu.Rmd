...
While GPU-accelerated operations will be much faster than their CPU-based 
...
Test your pipeline carefully to decide whether it is worth running all or parts
of it on the GPU, or to keep everything on the CPU instead. 

Copying an image to/from the GPU comes with a small time penalty. It is best if
your pipeline avoids performing too many copying operations. Ideally, the GPU/CPU
