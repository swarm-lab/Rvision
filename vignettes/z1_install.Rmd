...
on all major operating systems (Mac, Windows, and "Ubuntu-like" Linux). There 
are a few steps to follow before installing the package itself in order to 
prepare all the necessary dependencies. 
...
package. Installation instructions for [`ROpenCVLite`](https://github.com/swarm-lab/ROpenCVLite)
...
system is missing one of the external dependencies required by `ROpenCVLite`. 
