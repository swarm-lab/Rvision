...
+ [1 - Reading ](#reading)
    + [1.1 - Videos](#videos)
    + [1.2 - Camera streams](#camera-streams)
    + [1.3 - Images](#images)
        + [1.3.1 - From files](#from-files)
        + [1.3.2 - From videos](#from-videos)
        + [1.3.3 - From streams](#from-camera-streams)
+ [2 - Writing](#writing)
    + [2.1 - Videos](#videos-1)
    + [2.2 - Images](#images-1)
